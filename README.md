...
- [SSI](https://github.com/luciangreen/SSI), [List Prolog Interpreter](https://github.com/luciangreen/listprologinterpreter), and this should have a findall (see [Loop](https://github.com/luciangreen/loop) and prime (argument number indicator) converter to predicates for efficiency and ability to be converted to C.
